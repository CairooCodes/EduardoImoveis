    ...
    <div class="max-w-6xl px-4 pb-8 mx-auto lg:pb-16">
      <div class="grid lg:grid-cols-12 lg:pt-5">
        <div class="lg:col-span-7">
          ...
          <?php
          $img = base64_encode($product['img']);
          echo "<img class='w-full rounded-xl' src='data:image/jpeg;base64," . $img . "'>";
          ?>
        ...
        <div class="swiper-wrapper">
          ...
          if ($product['images']) {
            ...
            foreach ($imagens as $imagem) {
              ...
              echo "<div class='swiper-slide'><img class='w-100' src='data:image/jpeg;base64," . $imgs . "'></div>";
            }
          }
          ?>
        </div>
